...
|-------|----|------------|--------------|-------|
| my-agent:develop | d31e166020c2 | 1.66GB | 424MB | In use |
| my-agent:advanced | cf7e3a8dad09 | 236MB | 56.6MB | |
...
railway variables set AGENT_API_KEY=my-secret-key # 123456abc
```
...
6. Get public URL:
```bash
railway domain # https://day12-production-17df.up.railway.app
```
